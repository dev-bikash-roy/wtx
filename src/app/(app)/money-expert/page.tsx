...
export const metadata: Metadata = {
    title: 'Money Expert | WTX News',
    description: 'Expert money advice, deals, and saving hacks from WTX News',
}

const BLOG_API_BASE = 'https://blog.wtxnews.co.uk/wp-json/wp/v2'

export default async function MoneyExpertPage() {
    const posts = await fetchPostsByCategory('money-expert', 20, 1, BLOG_API_BASE)
    ...
    return (
        <div className="container pb-20 pt-10 lg:pb-24 lg:pt-16">
            <div className="mb-10 text-center lg:mb-16">
                <h1 className="text-3xl font-bold md:text-4xl lg:text-5xl">Money Expert</h1>
                <p className="mt-4 text-neutral-500 dark:text-neutral-400">
                    Smart advice for your wallet
                </p>
            </div>
            ...
            <div className="flex flex-col lg:flex-row">
                <div className="w-full lg:w-3/4 lg:pr-10">
                    <SectionGridPosts
                        posts={posts}
                        heading="Latest Money Advice"
                        subHeading="Save more, spend less"
