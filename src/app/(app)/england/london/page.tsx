...
export const metadata: Metadata = {
  title: 'London News | England | WTX News',
  description: 'Latest news from London. Breaking stories, local updates, and more from the capital.',
}

export const revalidate = 180

const Page = async () => {
  const posts = await getWordPressPostsByTag('london', 24)
  ...
  return (
    <div className="container pt-10 lg:pt-16 pb-16">
      ...
      <p className="text-neutral-600 dark:text-neutral-400 mb-8">
        Latest news and updates from London
      </p>
      ...
      {posts.length > 0 ? (
        ...
        <div className="text-center py-12">
          <p className="text-neutral-500">No London news available at the moment.</p>
