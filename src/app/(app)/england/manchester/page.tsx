...
export const metadata: Metadata = {
  title: 'Manchester News | England | WTX News',
  description: 'Latest news from Manchester. Breaking stories, local updates, and more.',
}

export const revalidate = 180

const Page = async () => {
  const posts = await getWordPressPostsByTag('manchester', 24)
  ...
  return (
    <div className="container pt-10 lg:pt-16 pb-16">
      <nav className="mb-6 text-sm">
        ...
        <span className="mx-2 text-neutral-400">/</span>
        <span className="text-neutral-600">Manchester</span>
      </nav>
      ...
      <p className="text-neutral-600 dark:text-neutral-400 mb-8">
        Latest news and updates from Manchester
      </p>
      ...
      {posts.length > 0 ? (
        ...
        <div className="text-center py-12">
          <p className="text-neutral-500">No Manchester news available at the moment.</p>
