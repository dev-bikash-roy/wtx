...
export const metadata: Metadata = {
    title: 'Fashion News & Trends | WTX News',
    description: 'Latest fashion trends, styling tips, and outfit ideas from WTX News',
}

const BLOG_API_BASE = 'https://blog.wtxnews.co.uk/wp-json/wp/v2'

export default async function FashionPage() {
    const posts = await fetchPostsByCategory('fashion', 20, 1, BLOG_API_BASE)
    ...
    return (
        <div className="container pb-20 pt-10 lg:pb-24 lg:pt-16">
            <div className="mb-10 text-center lg:mb-16">
                <h1 className="text-3xl font-bold md:text-4xl lg:text-5xl">Fashion</h1>
            ...
            <div className="flex flex-col lg:flex-row">
                <div className="w-full lg:w-3/4 lg:pr-10">
                    <SectionGridPosts
                        posts={posts}
                        heading="Latest in Fashion"
                        subHeading="Trends and Style"
