...
```ts
import { useCreateUser, useListArticles, useUpdateArticle, useGetUser } from '@dataconnect/generated/react';
// The types of these hooks are available in react/index.d.ts

const { data, isPending, isSuccess, isError, error } = useCreateUser();

const { data, isPending, isSuccess, isError, error } = useListArticles();

const { data, isPending, isSuccess, isError, error } = useUpdateArticle(updateArticleVars);
...
```js
import { createUser, listArticles, updateArticle, getUser } from '@dataconnect/generated';
